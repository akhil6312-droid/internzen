  ...
  return (
      ...
      className={`p-5 rounded-2xl border transition-all duration-200 flex flex-col justify-between ${
        candidate.isShortlisted
          ? isDark
            ...
            : 'bg-violet-50/50 border-violet-300 shadow-md'
          : isDark
    ...
    >
      <div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div
              className={`w-7 h-7 rounded-lg flex items-center justify-center text-xs font-black font-mono border ${
                rank === 1
                  ...
                  : rank === 3
                  ? 'bg-orange-500/20 border-orange-500/40 text-orange-500 dark:text-orange-300'
                  : isDark
            ...
            <div>
              ...
              <p className={`text-[11px] flex items-center gap-1 ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
                <GraduationCap className={`w-3 h-3 ${isDark ? 'text-slate-400' : 'text-slate-500'}`} />
        ...
        <div className={`space-y-2 mb-4 pt-2 border-t ${isDark ? 'border-slate-800/80' : 'border-slate-200'}`}>
          <div className={`flex items-center justify-between text-[11px] font-medium ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
      ...
      <div className={`pt-3 border-t flex items-center justify-between gap-2 ${isDark ? 'border-slate-800/80' : 'border-slate-200'}`}>
